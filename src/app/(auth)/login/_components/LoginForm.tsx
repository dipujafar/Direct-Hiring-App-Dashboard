...
export default function LoginForm() {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-y-hidden">
      <Image src={shadowImage1} alt="shadow"  className="absolute top-0 left-0 z-0 pointer-events-none"></Image>
    <div className="z-10 flex flex-col md:flex-row min-h-screen">
      ...
      <div className="md:w-1/3 flex items-center justify-center bg-background">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold text-foreground">Direct Hiring</h1>
        </div>
      </div>
        ...
        <div className="w-full max-w-2xl space-y-6">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Link href="/forget-password">  <Button
                  type="button"
                  variant="link"
     ...
     <Image src={shadowImage2} alt="shadow"  className="absolute bottom-0 right-0 z-0 pointer-events-none"></Image>
    </div>
  );
}
